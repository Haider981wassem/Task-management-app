...
export default function AddTaskModal({ show, onClose }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            setErrors({ api: "Failed to add task" })
        }
    }
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    {activeTab === 'basic' && (
                        <>
                            ...
                            <Row className="mb-3">
                                ...
                                <Col>
                                    <Form.Control type="time" name="DueTime" onChange={handleChange} />
                                </Col>
                            </Row>
                            <Row className="mb-3">
                                <Col>
                                ...
                                <Col>
                                    <Form.Select name="statusId" onChange={handleChange}>
                    ...
                    {activeTab === 'more' && (
                        <>
                            ...
                            <Form.Group className="mb-3">
                                <Form.Control as="textarea" rows={4} name="Description" placeholder="Description" onChange={handleChange} />
                            </Form.Group>
                            <div className="d-flex justify-content-end gap-2">
                                <Button variant="link" onClick={onClose}>CANCEL</Button>
